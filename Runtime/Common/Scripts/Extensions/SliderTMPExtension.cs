...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    [AddComponentMenu("UI/Extensions/Slider TMP Extended"), RequireComponent(typeof(RectTransform))]
    public sealed class SliderTMPExtension : Slider
    {
        [Header("Extended Properties")] [SerializeField]
        TMP_Text m_labelComponent;

        [SerializeField] TMP_Text m_valueComponent;
